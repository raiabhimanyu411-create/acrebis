  ...
  return <footer className="site-footer">
    ...
    <div className="container footer-bottom">
      <div className="footer-meta">
        <span>© 2026 ACREBIS AI. All rights reserved.</span>
        <span className="footer-credit">Designed and Developed by <b>Devmora Technology</b></span>
      </div>
      <div><Link to="/legal">Legal</Link><Link to="/privacy-policy">Privacy</Link><Link to="/terms-cookies">Terms & Cookies</Link><Link to="/security">Security</Link></div>
    </div>
  </footer>
}
